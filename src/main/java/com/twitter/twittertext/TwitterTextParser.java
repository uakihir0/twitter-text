...
public final class TwitterTextParser {
     ...
     */
    public static TwitterTextParseResults parseTweet(final String tweet) {
     ...
     */
    public static TwitterTextParseResults parseTweet(final String tweet,
                                                     final TwitterTextConfiguration config) {
     ...
     * @return {@link TwitterTextParseResults} object
     */
    public static TwitterTextParseResults parseTweetWithoutUrlExtraction(final String tweet) {
     ...
     * TwitterTextConfiguration.DEFAULT_TRANSFORMED_URL_LENGTH
     *
     * @param tweet       which is to be parsed
     * @param config      {@link TwitterTextConfiguration}
     ...
     * @return {@link TwitterTextParseResults} object
     */
    private static TwitterTextParseResults parseTweet(final String tweet,
                                                      final TwitterTextConfiguration config,
                                                      boolean extractURLs) {
